...
import ViewFarmProducts from "../components/ViewFarmProducts";

const FarmerToBusiness = () => {
  ...
  return (
    <div style={styles.container}>
      <h1>🚜 Farmer to Business Marketplace</h1>
      <p>Sell crops, tools, and other farm products directly to businesses.</p>
      ...
      <div style={styles.componentContainer}>
        {activeComponent === "add" && <AddFarmProduct />}
        {activeComponent === "view" && <ViewFarmProducts />}
      </div>
    </div>
  );
};
...
export default FarmerToBusiness;
